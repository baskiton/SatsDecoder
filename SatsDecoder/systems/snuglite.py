    ...
    tlm_table = {
        'simple': {
            'table': (
                ...
                ('pos_vel_pos', 'Position, cm', 1),
                ('pos_vel_vel', 'Velocity, cm/s', 1),
                ('calculated_height', 'Calculated height, km', 1),
                ('calculated_vel', 'Calculated velocity, m/s', 1),
                ('battery_mode', 'Battery mode', 0),
                ('battery_voltage', 'Battery voltage, mV', 1),
            ),
        },
        'full': {
            'table': (
                ...
                ('battery_mode', 'Battery mode', 0),
                ('battery_voltage', 'Battery voltage, mV', 1),
                ('battery_current', 'Battery current, mA', 1),
                ...
                ('ps_current/boom', 'PS boom current, mA', 1),
                ('ps_current/uhf', 'PS UHF current, mA', 2),
                ('ps_current/gps_up', 'PS GPS-up current, mA', 2),
                ('ps_current/sd_card', 'PS SD-card current, mA', 2),
                ('ps_current/magnetometer', 'PS magnetometer current, mA', 2),
                ('ps_current/gps_side', 'PS GPS-side current, mA', 2),
                ('solar_cell_inp_voltage/x', '±X solar cell Voltage, mV', 1),
                ('solar_cell_inp_voltage/y', '±Y solar cell Voltage, mV', 2),
                ('solar_cell_inp_voltage/z', '-Z solar cell Voltage, mV', 2),
                ('solar_cell_inp_curr/x', '±X solar cell current, mA', 1),
                ('solar_cell_inp_curr/y', '±Y solar cell current, mA', 2),
                ('solar_cell_inp_curr/z', '-Z solar cell current, mA', 2),
                ...
                ('sp_temp', 'Solar panel temperature, °C', 1),
                ('onboard_computer_temp', 'Onboard computer temperature, °C', 2),
                ('eps_temp', 'EPS module temperature, °C', 2),
                ('uhf_temp', 'UHF module temperature, °C', 2),
