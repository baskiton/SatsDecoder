    ...
    tlm_table = {
        'greencube_tlm': {
            'table': (
                ...
                ('eps_vboost_0', 'Voltage of X axis solar panels, mV', 0),
                ('eps_vboost_1', 'Voltage of Y axis solar panels, mV', 0),
                ('eps_cboost_0', 'Current of X axis solar panels, mA', 0),
                ('eps_cboost_1', 'Current of Y axis solar panels, mA', 0),
                ('eps_bootcause', 'EPS bootcause', 0),
                ('eps_temp_0', 'Temperature of X axis MPPT, °C', 0),
                ('eps_temp_1', 'Temperature of Y axis MPPT, °C', 0),
                ('eps_temp_2', 'Temperature of EPS board, °C', 0),
                ...
                ('eps_cursun', 'Total current from the solar panels, mA', 0),
                ('eps_cursys', 'Total current absorbed by the system, mA', 0),
                ...
                ('obc_temp_0', 'OBC temperature, °C', 0),
                ...
                ('pan_spt_0', 'Temperature of +X solar panel, °C', 0),
                ('pan_spt_1', 'Temperature of +Y solar panel, °C', 0),
                ('pan_spt_2', 'Temperature of -X solar panel, °C', 0),
                ('pan_spt_3', 'Temperature of -Y solar panel, °C', 0),
