    ...
    tlm_table = {
        'greencube_tlm': {
            'table': (
                ...
                ('eps_vboost_0', 'Voltage of X axis solar panels, mV', 1),
                ('eps_vboost_1', 'Voltage of Y axis solar panels, mV', 2),
                ('eps_cboost_0', 'Current of X axis solar panels, mA', 2),
                ('eps_cboost_1', 'Current of Y axis solar panels, mA', 2),
                ('eps_bootcause', 'EPS bootcause', 0),
                ('eps_temp_0', 'Temperature of X axis MPPT, °C', 1),
                ('eps_temp_1', 'Temperature of Y axis MPPT, °C', 2),
                ('eps_temp_2', 'Temperature of EPS board, °C', 2),
                ...
                ('eps_cursun', 'Total current from the solar panels, mA', 1),
                ('eps_cursys', 'Total current absorbed by the system, mA', 2),
                ('eps_vbatt', 'Battery voltage, mV', 1),
                ('eps_outputs', 'Status of EPS outputs', 0),
                ...
                ('eps_bootcounter', 'EPS bootcounter', 0),
                ('payload_rx_count', 'Packets from the payload', 0),
                ('payload_tx_count', 'Packets to the payload', 0),
                ('software_status', 'Software status flag', 0),
                ('heater_status', 'Heater status flag', 0),
                ('obc_temp_0', 'OBC temperature, °C', 1),
                ...
                ('pan_spt_0', 'Temperature of +X solar panel, °C', 1),
                ('pan_spt_1', 'Temperature of +Y solar panel, °C', 2),
                ('pan_spt_2', 'Temperature of -X solar panel, °C', 2),
                ('pan_spt_3', 'Temperature of -Y solar panel, °C', 2),
                ...
                ('gps_fix_time', 'GPS fix time', 0),
                ('gps_lat', 'GPS Latitude', 0),
                ('gps_lon', 'GPS Longitude', 0),
                ('gps_alt', 'GPS Altitude, km', 1),
                ('sband_tx_cnt', 'S-Band TX Count', 0),
                ('antenna_status', 'Antenna status flag', 0),
                ('acs_state', 'ACS state flag', 0),
                ('acs_param', 'ACS parameters flag', 0),
            ),
        },
        'greencube_msg': {
            'table': (
