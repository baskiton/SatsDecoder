    ...
    tlm_table = {
        'simba_tlm': {
            'table': (
                ...
                ('spx_u', 'Voltage of X axis solar panels, mV', 0),
                ('spy_u', 'Voltage of Y axis solar panels, mV', 0),
                ('spx_i', 'Current of X axis solar panels, mA', 0),
                ('spy_i', 'Current of Y axis solar panels, mA', 0),
                ('esp_bootcause', 'EPS bootcause', 0),
                ('esp_bat_mode', 'EPS battery mode', 0),
                ('mpptx_t', 'Temperature of X axis MPPT, °C', 0),
                ('mppty_t', 'Temperature of Y axis MPPT, °C', 0),
                ('esp_t', 'Temperature of EPS board, °C', 0),
                ('bat_t', 'Temperature of batteries, °C', 0),
                ('in_i', 'Total current coming from solar panels, mA', 0),
                ('absorbed_i', 'Total current absorbed by system, mA', 0),
                ('bat_u', 'Battery voltage, mV', 0),
                ('esp_boots', 'EPS boot count', 0),
                ('esp_status', 'Status of EPS outputs', 0),
                ('esp1_i', 'EPS output #1 current', 0),
                ('esp2_i', 'EPS output #2 current', 0),
                ('esp3_i', 'EPS output #3 current', 0),
                ('esp4_i', 'EPS output #4 current', 0),
                ('esp5_i', 'EPS output #5 current', 0),
                ('esp6_i', 'EPS output #6 current', 0),
                ('pa_tx_t', 'Temperature of transceiver PA, °C', 0),
                ('tx_cnt', 'Transceiver total TX count', 0),
                ('rx_cnt', 'Transceiver total RX count', 0),
                ('rssi', 'Last radio-contact RSSI, dBm', 0),
                ('radio_boots', 'Radio bootcounter', 0),
                ('att_mode', 'Current attitude mode', 0),
                ('pl_rx_cnt', 'Payload RX count', 0),
                ('obc_boots', 'OBC bootcounter', 0),
                ('obc_t', 'OBC temperature, °C', 0),
                ('gyro_x', 'Gyroscope X, deg/s', 0),
                ('gyro_y', 'Gyroscope Y, deg/s', 0),
                ('gyro_z', 'Gyroscope Z, deg/s', 0),
                ('mag_x', 'Magnetometer X, mG', 0),
                ('mag_y', 'Magnetometer Y, mG', 0),
                ('mag_z', 'Magnetometer Z, mG', 0),
                ('sp+x_t', 'Temperature of +X solar panel, °C', 0),
                ('sp+y_t', 'Temperature of +Y solar panel, °C', 0),
                ('sp-x_t', 'Temperature of -X solar panel, °C', 0),
                ('sp-y_t', 'Temperature of -Y solar panel, °C', 0),
                ('ss+x', 'Coarse Sun sensor +X, mV', 0),
                ('ss+y', 'Coarse Sun sensor +Y, mV', 0),
                ('ss+z', 'Coarse Sun sensor +Z, mV', 0),
                ('ss-x', 'Coarse Sun sensor -X, mV', 0),
                ('ss-y', 'Coarse Sun sensor -Y, mV', 0),
                ('ss-z', 'Coarse Sun sensor -Z, mV', 0),
                ('leds_stat', 'Status of the LEDs', 0),
                ('int_rweel_t', 'Temperature of the Reaction Wheel (internal), °C', 0),
                ('ext_rweel_t', 'Temperature of the Reaction Wheel (external), °C', 0),
                ('rweel_rpm', 'Speed of the Reaction Wheel, RPM', 0),
                ('rweel_ref_rpm', 'Reference speed of the Reaction Wheel, RPM', 0),
                ('rweel_ref_torque', 'Reference torque of the Reaction Wheel', 0),
