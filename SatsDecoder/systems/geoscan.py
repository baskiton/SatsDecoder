    ...
    tlm_table = {
        'geoscan_beacon': {
            'table': (
                ('name', 'Name', 0),
                ('Time', 'Time', 0),
                ('Iab', 'Current total, mA', 0),
                ('Isp', 'Current SP, mA', 0),
                ('Uab_per', 'Voltage per battery, V', 0),
                ('Uab_sum', 'Voltage total, V', 0),
                ('Tx_plus', 'Temperature SP X+, °C', 0),
                ('Tx_minus', 'Temperature SP X-, °C', 0),
                ('Ty_plus', 'Temperature SP Y+, °C', 0),
                ('Ty_minus', 'Temperature SP Y-, °C', 0),
                ('Tz_plus', 'Temperature SP Z+, °C', 0),
                ('Tz_minus', 'Temperature SP Z-, °C', 0),
                ('Tab1', 'Temperature battery #1, °C', 0),
                ('Tab2', 'Temperature battery #2, °C', 0),
                ('CPU_load', 'CPU load, %', 0),
                ('Nres_osc', 'Reloads spacecraft', 0),
                ('Nres_CommU', 'Reloads CommU', 0),
                ('RSSI', 'RSSI, dBm', 0),
                ('pad', 'pad', 0),
            )
        },
        'stratosat_beacon': {
            'table': (
                ...
                ('Uab_per', 'Voltage per battery, V', 0),
                ('Uab_sum', 'Voltage total, V', 0),
                ('Ichrg', 'Current of Charger, mA', 0),
                ('Itotal', 'Current amount, mA', 0),
                ('Tx_plus', 'Temperature SP X+, °C', 0),
                ('Tx_minus', 'Temperature SP X-, °C', 0),
                ('Ty_plus', 'Temperature SP Y+, °C', 0),
                ('Ty_minus', 'Temperature SP Y-, °C', 0),
        ...
        'geoscan2_beacon': {
            'table': (
                ...
                ('eps_name', '#', 0),
                ('eps_mode', 'EPS mode', 0),
                ('Ipl', 'Current total, mA', 0),
                ('Isp', 'Current SP, mA', 0),
                ('Uab_per', 'Voltage per battery, mV', 0),
                ('Uab_sum', 'Voltage total, mV', 0),
                ('Tab1', 'Temperature battery #1, °C', 0),
                ('Tab2', 'Temperature battery #2, °C', 0),

                ('obc_name', '#', 0),
                ('obc_act/flyweel', 'Flyweels act', 0),
                ('obc_act/coil', 'Coils act', 0),
                ('obc_act/ins', 'INS act', 0),
                ('obc_act/cam', 'Cam act', 0),
                ('obc_act/x_plus', 'Panel X+ act', 0),
                ('obc_act/x_minus', 'Panel X- act', 0),
                ('obc_act/y_plus', 'Panel Y+ act', 0),
                ('obc_act/y_minus', 'Panel Y- act', 0),
                ('Tx_plus', 'Temperature X+, °C', 0),
                ('Tx_minus', 'Temperature X-, °C', 0),
                ('Ty_plus', 'Temperature Y+, °C', 0),
                ('Ty_minus', 'Temperature Y-, °C', 0),
                ('gnss_num', 'GNSS satellites', 0),
                ('camera_files', 'Camera files', 0),

                ('commu_name', '#', 0),
                ('Uvbus', 'VBUS voltage, mV', 0),
                ('rssi_last', 'RSSI last, dBm', 0),
                ('rssi_min', 'RSSI min, dBm', 0),
                ('tx_num', 'TX packets', 0),
                ('qso_num', 'QSO numbers', 0),
            ),
        },
    }
