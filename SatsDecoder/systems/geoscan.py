    ...
    tlm_table = {
        'geoscan_beacon': {
            'table': (
                ('name', 'Name', 0),
                ('Time', 'Time', 0),
                ('Iab', 'Current total, mA', 1),
                ('Isp', 'Current SP, mA', 2),
                ('Uab_per', 'Voltage per battery, V', 1),
                ('Uab_sum', 'Voltage total, V', 2),
                ('Tx_plus', 'Temperature SP X+, °C', 1),
                ('Tx_minus', 'Temperature SP X-, °C', 2),
                ('Ty_plus', 'Temperature SP Y+, °C', 2),
                ('Ty_minus', 'Temperature SP Y-, °C', 2),
                ('Tz_plus', 'Temperature SP Z+, °C', 2),
                ('Tz_minus', 'Temperature SP Z-, °C', 2),
                ('Tab1', 'Temperature battery #1, °C', 1),
                ('Tab2', 'Temperature battery #2, °C', 2),
                ('CPU_load', 'CPU load, %', 1),
        ...
        'stratosat_beacon': {
            'table': (
                ...
                ('Uab_per', 'Voltage per battery, V', 1),
                ('Uab_sum', 'Voltage total, V', 2),
                ('Ichrg', 'Current of Charger, mA', 1),
                ('Itotal', 'Current amount, mA', 2),
                ('Tx_plus', 'Temperature SP X+, °C', 1),
                ('Tx_minus', 'Temperature SP X-, °C', 2),
                ('Ty_plus', 'Temperature SP Y+, °C', 2),
                ('Ty_minus', 'Temperature SP Y-, °C', 2),
        ...
        'geoscan2_beacon': {
            'table': (
                ...
                ('eps_name', '#', 0),
                ('eps_mode', 'EPS mode', 0),
                ('Ipl', 'Current total, mA', 1),
                ('Isp', 'Current SP, mA', 2),
                ('Uab_per', 'Voltage per battery, mV', 1),
                ('Uab_sum', 'Voltage total, mV', 2),
                ('Tab1', 'Temperature battery #1, °C', 1),
                ('Tab2', 'Temperature battery #2, °C', 2),
                ...
                ('Tx_plus', 'Temperature X+, °C', 1),
                ('Tx_minus', 'Temperature X-, °C', 2),
                ('Ty_plus', 'Temperature Y+, °C', 2),
                ('Ty_minus', 'Temperature Y-, °C', 2),
                ('gnss_num', 'GNSS satellites', 1),
                ('camera_files', 'Camera files', 1),

                ('commu_name', '#', 0),
                ('Uvbus', 'VBUS voltage, mV', 1),
                ('rssi_last', 'RSSI last, dBm', 1),
                ('rssi_min', 'RSSI min, dBm', 2),
                ('tx_num', 'TX packets', 0),
