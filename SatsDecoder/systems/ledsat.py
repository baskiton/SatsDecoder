    ...
    tlm_table = {
        'ledsat_tlm': {
            'table': (
                ...
                ('Time', 'On-board unix time', 0),
                ('proctime', 'Time taken to process the telemetry, ms', 0),
                ('eps_vboost_0', 'Voltage of the X axis solar panels, mV', 1),
                ('eps_vboost_1', 'Voltage of the Y axis solar panels, mV', 2),
                ('eps_vboost_2', 'Voltage of the Z axis solar panels, mV', 2),
                ('eps_cboost_0', 'Current of the X axis solar panels, mA', 2),
                ('eps_cboost_1', 'Current of the Y axis solar panels, mA', 2),
                ('eps_cboost_2', 'Current of the Z axis solar panels, mA', 2),
                ('eps_bootcause', 'EPS bootcause', 0),
                ('eps_battmode', 'EPS battery mode', 0),
                ('eps_temp_0', 'Temperature of the X axis MPPT, °C', 1),
                ('eps_temp_1', 'Temperature of the Y axis MPPT, °C', 2),
                ('eps_temp_2', 'Temperature of the Z axis MPPT, °C', 2),
                ('eps_temp_3', 'Temperature of battery pack #1, °C', 2),
                ('eps_temp_4', 'Temperature of battery pack #2, °C', 2),
                ('eps_temp_5', 'Temperature of battery pack #3, °C', 2),
                ('eps_cursun', 'Total current coming from solar panels, mA', 1),
                ('eps_cursys', 'Total current absobred by system, mA', 2),
                ('eps_vbatt', 'Battery voltage, mV', 1),
                ('eps_gpscur', 'GPS current draw, mA', 1),
                ('eps_bootcounter', 'EPS bootcount', 0),
                ('radio_temp_pa', 'Temperature of transceiver PA, °C', 1),
                ('radio_tx_count', 'Transceiver total TX count', 0),
                ('radio_rx_count', 'Transceiver total RX count', 0),
                ('radio_last_rssi', 'Last radio-contact RSSI, dBm', 1),
                ('radio_bootcounter', 'Radio bootcounter', 0),
                ('obc_temp_0', 'OBC temperature #1, °C', 1),
                ('obc_temp_1', 'OBC temperature #2, °C', 2),
                ('obc_gyro_0', 'Gyroscope X, °/s', 1),
                ('obc_gyro_1', 'Gyroscope Y, °/s', 2),
                ('obc_gyro_2', 'Gyroscope Z, °/s', 2),
                ('obc_mag_0', 'Magnetometer X, mG', 1),
                ('obc_mag_1', 'Magnetometer Y, mG', 2),
                ('obc_mag_2', 'Magnetometer Z, mG', 2),
                ('pan_spt_0', 'Temperature of the +X solar panel, °C', 1),
                ('pan_spt_1', 'Temperature of the +Y solar panel, °C', 2),
                ('pan_spt_2', 'Temperature of the -X solar panel, °C', 2),
                ('pan_spt_3', 'Temperature of the -Y solar panel, °C', 2),
                ('pan_spt_4', 'Temperature of the +Z solar panel, °C', 2),
                ('pan_spt_5', 'Temperature of the -Z solar panel, °C', 2),
                ('pan_css_0', 'Coarse Sun Sensor +X, mV', 1),
                ('pan_css_1', 'Coarse Sun Sensor +Y, mV', 2),
                ('pan_css_2', 'Coarse Sun Sensor +Z, mV', 2),
                ('pan_css_3', 'Coarse Sun Sensor -X, mV', 2),
                ('pan_css_4', 'Coarse Sun Sensor -Y, mV', 2),
                ('pan_css_5', 'Coarse Sun Sensor -Z, mV', 2),
                ('eps_outputs', 'EPS output status', 0),
                ('obc_bootcounter', 'OBC bootcounter', 0),
                ('led_status', 'Status of the LEDs', 0),
                ('gps_status_flag', 'GPS Status Flag', 0),
                ('gps_fix_time', 'GPS fix time (UNIX)', 0),
                ('gps_lat', 'GPS Latitude, °', 0),
                ('gps_lon', 'GPS Longitude, °', 0),
                ('gps_alt', 'GPS Altitude, m', 1),
                ('software_status', 'Software status flag', 0),
                ('ext_gyro_0', 'External Gyroscope X, °/s', 1),
                ('ext_gyro_1', 'External Gyroscope Y, °/s', 2),
                ('ext_gyro_2', 'External Gyroscope Z, °/s', 2),
                ('ext_mag_0', 'External Magnetometer X, mG', 1),
                ('ext_mag_1', 'External Magnetometer Y, mG', 2),
                ('ext_mag_2', 'External Magnetometer Z, mG', 2),
            ),
        },
