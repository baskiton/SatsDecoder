    ...
    tlm_table = {
        'eser': {
            'table': (
                ...
                ('board_temp1', 'Board Temp #1, °C', 0),
                ('board_temp2', 'Board Temp #2, °C', 0),
                ('board_temp3', 'Board Temp #3, °C', 0),
                ('vbat_v', 'vbat_v, V', 0),
                ('vbat_i', 'vbat_i, A', 0),
                ('vbat_plat_v', 'vbat_plat_v, V', 0),
                ('3v3_plat_v', '3v3_plat_v, V', 0),
                ('vbat_periph_i', 'vbat_periph_i, A', 0),
                ('3v3_periph_i', '3v3_periph_i, A', 0),
                ('vbat_periph_v', 'vbat_periph_v, V', 0),
                ('3v3_periph_v', '3v3_periph_v, V', 0),
                ...
                ('rtc_yy', 'RTC YY', 0),
                ('rtc_dow', 'RTC DOW', 0),
                ('rtc_temp', 'RTC Temperature, °C', 0),
                ('antenna_status', 'Antenna Status', 0),

                ('vbat', 'Battery Voltage, V', 0),
                ('ibat', 'Battery Current, mA', 0),
                ('vpcm3v3', 'PCM 3v3 Voltage, V', 0),
                ('vpcm5v', 'PCM 5v Voltage, V', 0),
                ('ipcm3v3', 'PCM 3v3 Current, mA', 0),
                ('ipcm5v', 'PCM 5v Current, mA', 0),
                ('tbrd', 'Board Temperature, °C', 0),
                ('tbat1', 'Battery #1 Temperature, °C', 0),
                ('tbat2', 'Battery #2 Temperature, °C', 0),
                ('tbat3', 'Battery #3 Temperature, °C', 0),

                ('eps_vpcmbatv', 'EPS PCM Battery Voltage, V', 0),
                ('eps_ipcmbatv', 'EPS PCM Battery Current, A', 0),
                ('eps_vpcm3v3', 'EPS PCM 3v3 Voltage, V', 0),
                ('eps_ipcm3v3', 'EPS PCM 3v3 Current, A', 0),
                ('eps_vpcm5v', 'EPS PCM 5v Voltage, V', 0),
                ('eps_ipcm5v', 'EPS PCM 5v Current, A', 0),
                ('eps_i3v3drw', 'EPS PCM 3v3 DRW Current, A', 0),
                ('eps_i5vdrw', 'EPS PCM 5v DRW Current, A', 0),
                ('eps_tbrd', 'EPS Board Temperature, °C', 0),
                ('eps_tbrd_db', 'EPS Board DB Temperature, °C', 0),
                ('eps_ipcm12v', 'EPS PCM 12v Current, A', 0),
                ('eps_vpcm12v', 'EPS PCM 12v Voltage, V', 0),

                ('adcs_state', 'ADCS State', 0),
                ('sat_pos_llh_lat', 'Sat llh lat, deg', 0),
                ('sat_pos_llh_lon', 'Sat llh lon, deg', 0),
                ('sat_pos_llh_alt', 'Sat llh alt, km', 0),
                ('estm_att_angle_yaw', 'Yaw, deg', 0),
                ('estm_att_angle_pitch', 'Pitch, deg', 0),
                ('estm_att_angle_roll', 'Roll, deg', 0),
                ('estm_ang_rate_yaw', 'Yaw rate, deg/s', 0),
                ('estm_ang_rate_pitch', 'Pitch rate, deg/s', 0),
                ('estm_ang_rate_roll', 'Roll rate, deg/s', 0),
                ('gps', 'ECEF Pos&Vel Vectors', 0),

                ('smps_temp', 'UHF/VHF SMPS Temperature, °C', 0),
                ('pa_temp', 'UHF/VHF PA Temperature, °C', 0),
                ('current_3v3', 'UHF/VHF 3v3 Current, uA', 0),
                ('voltage_3v3', 'UHF/VHF 3v3 Voltage, mV', 0),
                ('current_5v', 'UHF/VHF 5v Current, uA', 0),
                ('voltage_5v', 'UHF/VHF 5v Voltage, mV', 0),

                ('battery_current', 'S-Band Battery Current, uA', 0),
                ('pa_current', 'S-Band PA Current, uA', 0),
                ('battery_voltage', 'S-Band Battery Voltage, mV', 0),
                ('pa_voltage', 'S-Band PA Voltage, mV', 0),
                ('pa_temperature', 'S-Band PA Temperature, °C', 0),
                ('rf_output_power', 'S-Band RF Output power, Vdet', 0),
                ('board_temp_top', 'S-Band Board Temp top, °C', 0),
                ('board_temp_bottom', 'S-Band Board Temp bottom, °C', 0),

                ('vbcr1', 'SP #1 Voltage, V', 0),
                ('vbcr2', 'SP #2 Voltage, V', 0),
                ('vbcr3', 'SP #3 Voltage, V', 0),
                ('vbcr4', 'SP #4 Voltage, V', 0),
                ('vbcr5', 'SP #5 Voltage, V', 0),
                ('vbcr6', 'SP #6 Voltage, V', 0),
                ('vbcr7', 'SP #7 Voltage, V', 0),
                ('vbcr8', 'SP #8 Voltage, V', 0),
                ('vbcr9', 'SP #9 Voltage, V', 0),
                ('ibcra1', 'SP #a1 Current, A', 0),
                ('ibcra2', 'SP #a2 Current, A', 0),
                ('ibcra3', 'SP #a3 Current, A', 0),
                ('ibcra4', 'SP #a4 Current, A', 0),
                ('ibcra5', 'SP #a5 Current, A', 0),
                ('ibcra6', 'SP #a6 Current, A', 0),
                ('ibcra7', 'SP #a7 Current, A', 0),
                ('ibcra8', 'SP #a8 Current, A', 0),
                ('ibcra9', 'SP #a9 Current, A', 0),
                ('ibcrb1', 'SP #b1 Current, A', 0),
                ('ibcrb2', 'SP #b2 Current, A', 0),
                ('ibcrb3', 'SP #b3 Current, A', 0),
                ('ibcrb4', 'SP #b4 Current, A', 0),
                ('ibcrb5', 'SP #b5 Current, A', 0),
                ('ibcrb6', 'SP #b6 Current, A', 0),
                ('ibcrb7', 'SP #b7 Current, A', 0),
                ('ibcrb8', 'SP #b8 Current, A', 0),
                ('ibcrb9', 'SP #b9 Current, A', 0),
                ('tbcra1', 'SP #a1 Temperature, °C', 0),
                ('tbcra2', 'SP #a2 Temperature, °C', 0),
                ('tbcra3', 'SP #a3 Temperature, °C', 0),
                ('tbcra4', 'SP #a4 Temperature, °C', 0),
                ('tbcra5', 'SP #a5 Temperature, °C', 0),
                ('tbcra6', 'SP #a6 Temperature, °C', 0),
                ('tbcra7', 'SP #a7 Temperature, °C', 0),
                ('tbcra8', 'SP #a8 Temperature, °C', 0),
                ('tbcra9', 'SP #a9 Temperature, °C', 0),
                ('tbcrb1', 'SP #b1 Temperature, °C', 0),
                ('tbcrb2', 'SP #b2 Temperature, °C', 0),
                ('tbcrb3', 'SP #b3 Temperature, °C', 0),
                ('tbcrb4', 'SP #b4 Temperature, °C', 0),
                ('tbcrb5', 'SP #b5 Temperature, °C', 0),
                ('tbcrb6', 'SP #b6 Temperature, °C', 0),
                ('tbcrb7', 'SP #b7 Temperature, °C', 0),
                ('tbcrb8', 'SP #b8 Temperature, °C', 0),
                ('tbcrb9', 'SP #b9 Temperature, °C', 0),
                ('vidiodeout', 'I-Diode Voltage, V', 0),
                ('iidiodeout', 'I-Diode Current, A', 0),
            ),
            'flags': (
                ('battery', 'Battery', 0),
                ('eps', 'EPS', 0),
