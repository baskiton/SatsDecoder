    ...
    tlm_table = {
        ...
        'get_Payload_telemetry': {
            'table': (
                ...
                ('T_CPU', 'PL microcontroller temperature', 2),
                ('CurSens1', 'Current sensor #1', 1),
                ('CurSens2', 'Current sensor #2', 2),
                ('NRst', 'Reboots count', 0),
                ('TimeRst', 'Last reboot time', 0),
                ('CH1Rate', 'Ch#1 counting speed', 1),
                ('CH2Rate', 'Ch#2 counting speed', 2),
                ('CH3Rate', 'Ch#3 counting speed', 2),
                ('CH4Rate', 'Ch#4 counting speed', 2),
                ('CH5Rate', 'Ch#5 counting speed', 2),
                ('CH6Rate', 'Ch#6 counting speed', 2),
        ...
        'beacon': {
            'table': (
                ...
                ('Usb2', 'Solar Panel #2 voltage, mV', 2),
                ('Usb3', 'Solar Panel #3 voltage, mV', 2),
                ('Isb1', 'Solar Panel #1 current, mA', 1),
                ('Isb2', 'Solar Panel #2 current, mA', 2),
                ('Isb3', 'Solar Panel #3 current, mA', 2),
                ('Iab', 'Battery current, mA', 1),
                ('Ich1', 'Ch#1 current, mA', 1),
                ('Ich2', 'Ch#2 current, mA', 2),
                ('Ich3', 'Ch#3 current, mA', 2),
                ('Ich4', 'Ch#4 current, mA', 2),
                ('t1_pw', 'Battery #1 temperature, °C', 1),
                ('t2_pw', 'Battery #2 temperature, °C', 2),
                ('t3_pw', 'Battery #3 temperature, °C', 2),
                ('t4_pw', 'Battery #4 temperature, °C', 2),
                ('Uab', 'Battery voltage, mV', 1),
                ('reg_tel_id', 'PSS telemetry SN', 0),
                ('Time', 'PSS telemetry time', 0),
                ('Nres', 'PSS reset counter', 0),
                ('FL', 'PS flags', 0),
                ('t_amp', 'UHF amp temperature, °C', 1),
                ('t_uhf', 'UHF temperature, °C', 2),
                ('RSSIrx', 'RX RSSI, dBm', 1),
                ('RSSIidle', 'Idle RSSI, dBm', 2),
                ('Pf', 'Forward wave power, dBm', 1),
                ('Pb', 'Reflected wave power, dBm', 2),
                ('Nres_uhf', 'UHF reset counter', 0),
                ('FL_uhf', 'UHF flags', 0),
        ...
        'extended_beacon': {
            'table': (
                ...
                ('My', 'Y magnetic field vector', 2),
                ('Mz', 'Z magnetic field vector', 2),
                ('Vx', 'X velocity', 1),
                ('Vy', 'Y velocity', 2),
                ('Vz', 'Z velocity', 2),
                ('Nres', 'Reloads', 0),
        ...
        'uhf_beacon': {
            'table': (
                ...
                ('Pf', 'Forward wave power, dBm', 1),
                ('Pb', 'Reflected wave power, dBm', 2),
                ('uhf_reset_counter', 'UHF reset counter', 0),
                ('FL', 'UHF flags', 0),
                ('Time', 'UHF time', 0),
                ('UpTime', 'Uptime', 0),
        ...
        'extended_telemetry': {
            'table': (
                ...
                ('TMP_MAX', 'Battery max temperature, °C', 2),
                ('VTG_BAT', 'Battery drawdown voltage, mV', 1),
                ('TIME_BAT', 'Battery drawdown time, ms', 1),
                ('CUR_LIM1', 'Ch#1 current limit', 1),
                ('CUR_LIM2', 'Ch#2 current limit', 2),
                ('CUR_LIM3', 'Ch#3 current limit', 2),
                ('CUR_LIM4', 'Ch#4 current limit', 2),
        ...
        'ps_regular_telemetry_5ch': {
            'table': (
                ...
                ('VTG_SOL2', 'Solar Panel #2 Voltage, mV', 2),
                ('VTG_SOL3', 'Solar Panel #3 Voltage, mV', 2),
                ('CUR_SOL1', 'Solar Panel #1 Current, mA', 1),
                ('CUR_SOL2', 'Solar Panel #2 Current, mA', 2),
                ('CUR_SOL3', 'Solar Panel #3 Current, mA', 2),
                ('CUR_BAT', 'Battery Current, mA', 1),
                ('CUR_PCH1', 'Ch#1 Current, mA', 1),
                ('CUR_PCH2', 'Ch#2 Current, mA', 2),
                ('CUR_PCH3', 'Ch#3 Current, mA', 2),
                ('CUR_PCH4', 'Ch#4 Current, mA', 2),
                ('CUR_PCH5', 'Ch#5 Current, mA', 2),
                ('TMP_BAT1', 'Battery #1 temperature, °C', 1),
                ('TMP_BAT2', 'Battery #2 temperature, °C', 2),
                ('TMP_BAT3', 'Battery #3 temperature, °C', 2),
                ('TMP_BAT4', 'Battery #4 temperature, °C', 2),
        ...
        'tm_adcs_beacon_old': {
            'table': (
                ...
                ('eci_quat_vect_x', 'ECI quat vect x', 2),
                ('eci_quat_vect_y', 'ECI quat vect y', 2),
                ('eci_quat_vect_z', 'ECI quat vect z', 2),
                ('eci_ave_x', 'ECI ave x', 1),
                ('eci_ave_y', 'ECI ave y', 2),
                ('eci_ave_z', 'ECI ave z', 2),
                ('orb_time', 'ORB time', 0),
                ('orb_quat_w', 'ORB quat w', 1),
                ('orb_quat_vect_x', 'ORB quat vect x', 2),
                ('orb_quat_vect_y', 'ORB quat vect y', 2),
                ('orb_quat_vect_z', 'ORB quat vect z', 2),
                ('orb_ave_x', 'ORB ave x', 1),
                ('orb_ave_y', 'ORB ave y', 2),
                ('orb_ave_z', 'ORB ave z', 2),
                ('forced_time', 'Forced time', 0),
                ('forced_quat_w', 'Forced quat w', 1),
                ('forced_quat_vect_x', 'Forced quat vect x', 2),
                ('forced_quat_vect_y', 'Forced quat vect y', 2),
                ('forced_quat_vect_z', 'Forced quat vect z', 2),
                ('forced_ave_x', 'Forced ave x', 1),
                ('forced_ave_y', 'Forced ave y', 2),
                ('forced_ave_z', 'Forced ave z', 2),
                ('ss_invalids', 'SS invalids', 0),
                ('wheel_invalids', 'Wheel invalids', 0),
            ),
            'flags': (
        ...
        'tm_adcs_beacon': {
            'table': (
                ...
                ('eci_AV_y', 'ECI Y Angular velocity, deg/s', 2),
                ('eci_AV_z', 'ECI Z Angular velocity, deg/s', 2),
                ('orb_quat_w', 'ORB quat w', 1),
                ('orb_quat_vect_x', 'ORB quat vect x', 2),
                ('orb_quat_vect_y', 'ORB quat vect y', 2),
                ('orb_quat_vect_z', 'ORB quat vect z', 2),
                ('orb_AV_x', 'ORB X Angular velocity, deg/s', 1),
                ('orb_AV_y', 'ORB Y Angular velocity, deg/s', 2),
                ('orb_AV_z', 'ORB Z Angular velocity, deg/s', 2),
                ('eci_forced_quat_w', 'ECI forced quat w', 1),
                ('eci_forced_quat_vect_x', 'ECI forced quat vect x', 2),
                ('eci_forced_quat_vect_y', 'ECI forced quat vect y', 2),
                ('eci_forced_quat_vect_z', 'ECI forced quat vect z', 2),
                ('eci_forced_AV_x', 'ECI forced X Angular velocity, deg/s', 1),
                ('eci_forced_AV_y', 'ECI forced Y Angular velocity, deg/s', 2),
                ('eci_forced_AV_z', 'ECI forced Z Angular velocity, deg/s', 2),
                ...
                ('wheel_rpm_x_minus', 'Wheels X- angular velocity, rpm', 2),
                ('wheel_rpm_y_plus', 'Wheels Y+ angular velocity, rpm', 2),
                ('wheel_rpm_y_minus', 'Wheels Y- angular velocity, rpm', 2),
            ),
            'flags': (
                ('eci_policy', 'ECI policy', 0),
                ('eci_invalid', 'ECI invalid', 0),
        ...
        'tm_adcs_beacon_6_wheels': {
            'table': (
                ...
                ('wheel_rpm_2', 'Wheels #2 angular velocity, rpm', 2),
                ('wheel_rpm_3', 'Wheels #3 angular velocity, rpm', 2),
                ('wheel_rpm_4', 'Wheels #4 angular velocity, rpm', 2),
                ('wheel_rpm_5', 'Wheels #5 angular velocity, rpm', 2),
                ('wheel_rpm_6', 'Wheels #6 angular velocity, rpm', 2),
                ('reset_reason', 'Last reset reason', 0),
            ),
            'flags': (
                ('eci_policy', 'ECI policy', 0),
