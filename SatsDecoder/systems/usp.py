...
class UspProtocol(common.Protocol):
    ...
    _regular_tmpl = {
        'table': (
            ...
            ('voltage', 'Voltage, mV', 1),
        ),
        'flags': (
            ('current_invalid', 'Current invalid', 0),
            ('voltage_invalid', 'Voltage invalid', 0),
        ),
    }
    _ack_tmpl = {
        'table': (
    ...
    _ratesens_regular_tmpl = {
        'table': (
            ('name', 'Name', 0),
            ('desc', 'Description', 0),
            ('velocity', 'Velocity, deg/s', 1),
            ('temperature', 'Temperature, °C', 1),
        ),
        'flags': (
            ('counter', 'Counter', 0),
            ('invalid', 'Data is not valid', 0),
        ),
    }
    ...
    tlm_table = {
        ...
        'Info': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('SW_VER', 'Firmware version', 0),
                ('SERIAL', 'Board serial number', 0),
                ('CANTEL', 'CAN Telemetry mode', 0),
                ('UARTTEL', 'UART Telemetry mode', 0),
                ('ADC_REF', 'ADC reference value, mV', 0),
                ('THRESHOLD', 'Brightness threshold', 0),
                ('SET_STAT', 'Parameters loading result', 0),
                ('LM70_STAT', 'Temperature polynomial loading result', 0),
                ('VECT_STAT', 'Vector polynomial loading result', 0),
            ),
        },
        'regular_temperature': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('temperature0', 'Temperature #0', 1),
                ('temperature1', 'Temperature #1', 1),
            ),
            'flags': (
                ('temperature1_invalid', 'Temperature #1 invalid', 0),
                ('temperature0_invalid', 'Temperature #0 invalid', 0),
            ),
        },
        'get_Payload_telemetry': {
            'table': (
                ...
                ('desc', 'Description', 0),
                ('FL', 'PL flags', 0),
                ('Time', 'PL last telemetry time', 0),
                ('T_Plate', 'PL board temperature', 1),
                ('T_CPU', 'PL microcontroller temperature', 1),
                ('CurSens1', 'Current sensor #1', 1),
                ('CurSens2', 'Current sensor #2', 1),
                ('NRst', 'Reboots count', 1),
                ('TimeRst', 'Last reboot time', 0),
                ('CH1Rate', 'Ch#1 counting speed', 1),
                ('CH2Rate', 'Ch#2 counting speed', 1),
                ('CH3Rate', 'Ch#3 counting speed', 1),
                ('CH4Rate', 'Ch#4 counting speed', 1),
                ('CH5Rate', 'Ch#5 counting speed', 1),
                ('CH6Rate', 'Ch#6 counting speed', 1),
                ('PtrEnd1', 'Last block pointer transferred from segment #1', 0),
                ('PtrCrt1', 'Block pointer to be written from segment #1', 0),
                ('PtrEnd2', 'Last block pointer transferred from segment #2', 0),
                ('PtrCrt2', 'Block pointer to be written from segment #2', 0),
                ('PtrEnd3', 'Last block pointer transferred from segment #3', 0),
                ('PtrCrt3', 'Block pointer to be written from segment #3', 0),
                ('LastEvent_CH1_1', 'Last event Ch#1 M1L1', 0),
                ('LastEvent_CH1_2', 'Last event Ch#1 L2H1', 0),
                ('LastEvent_CH1_3', 'Last event Ch#1 H2M2', 0),
                ('LastEvent_CH2_1', 'Last event Ch#2 M1L1', 0),
                ('LastEvent_CH2_2', 'Last event Ch#2 L2H1', 0),
                ('LastEvent_CH2_3', 'Last event Ch#2 H2M2', 0),
            ),
        },
        ...
        'Brightness': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('Sum', 'Channels total brightness', 1),
            ),
        },
        'common_telemetry': {
            'table': (
        ...
        'vhf_settings': {
            'table': (
                ...
                ('BitRate', 'Bitrate', 0),
                ('DAC1Setting', 'DAC #1 Setting', 0),
                ('DAC2Setting', 'DAC #2 Setting', 0),
                ('TPacketMode', 'TPacket Mode', 0),
                ('EnableBeacon', 'Enable Beacon', 0),
                ('BeaconInterval', 'Beacon Interval', 0),
                ('CallSign', 'Callsign', 0),
                ('SSID', 'SSID', 0),
                ('EarthCallSign', 'Earth Callsign', 0),
                ('EarthSSID', 'Earth SSID', 0),
                ('TLocation', 'TLocation', 0),
                ('UNIcanID', 'UNIcan ID', 0),
                ('EnableBridge', 'Enable Bridge', 0),
                ('BeaconStartupDelay', 'Beacon Startup Delay', 0),
            ),
        },
        'beacon': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('Usb1', 'Solar Panel #1 voltage, mV', 1),
                ('Usb2', 'Solar Panel #2 voltage, mV', 1),
                ('Usb3', 'Solar Panel #3 voltage, mV', 1),
                ('Isb1', 'Solar Panel #1 current, mA', 1),
                ('Isb2', 'Solar Panel #2 current, mA', 1),
                ('Isb3', 'Solar Panel #3 current, mA', 1),
                ('Iab', 'Battery current, mA', 1),
                ('Ich1', 'Ch#1 current, mA', 1),
                ('Ich2', 'Ch#2 current, mA', 1),
                ('Ich3', 'Ch#3 current, mA', 1),
                ('Ich4', 'Ch#4 current, mA', 1),
                ('t1_pw', 'Battery #1 temperature, °C', 1),
                ('t2_pw', 'Battery #2 temperature, °C', 1),
                ('t3_pw', 'Battery #3 temperature, °C', 1),
                ('t4_pw', 'Battery #4 temperature, °C', 1),
                ('Uab', 'Battery voltage, mV', 1),
                ('reg_tel_id', 'PSS telemetry SN', 1),
                ('Time', 'PSS telemetry time', 0),
                ('Nres', 'PSS reset counter', 1),
                ('FL', 'PS flags', 0),
                ('t_amp', 'UHF amp temperature, °C', 1),
                ('t_uhf', 'UHF temperature, °C', 1),
                ('RSSIrx', 'RX RSSI, dBm', 1),
                ('RSSIidle', 'Idle RSSI, dBm', 1),
                ('Pf', 'Forward wave power, dBm', 1),
                ('Pb', 'Reflected wave power, dBm', 1),
                ('Nres_uhf', 'UHF reset counter', 1),
                ('FL_uhf', 'UHF flags', 0),
                ('Time_uhf', 'UHF telemetry time', 0),
                ('UpTime', 'Uptime', 0),
                ('Current', 'UHF consumption current, mA', 1),
                ('Uuhf', 'UHF voltage, mV', 1),
            ),
            'flags': (
                ('Uab_crit', 'Critical battery voltage', 0),
                ('Uab_min', 'Minimal battery voltage', 0),
                ('heater2_manual', 'Heater #2 manual', 0),
                ('heater1_manual', 'Heater #1 manual', 0),
                ('heater2_on', 'Heater #2 ON', 0),
                ('heater1_on', 'Heater #1 ON', 0),
                ('Tab_max', 'Maximal battery Temperature', 0),
                ('Tab_min', 'Minimal battery Temperature', 0),
                ('channelon4', 'Ch#4 ON', 0),
                ('channelon3', 'Ch#3 ON', 0),
                ('channelon2', 'Ch#2 ON', 0),
                ('channelon1', 'Ch#1 ON', 0),
                ('Ich_limit4', 'Exceeding channel #4 current', 0),
                ('Ich_limit3', 'Exceeding channel #3 current', 0),
                ('Ich_limit2', 'Exceeding channel #2 current', 0),
                ('Ich_limit1', 'Exceeding channel #1 current', 0),
                ('Additional_channel_3_on', 'Aux Ch#3 ON', 0),
                ('Additional_channel_2_on', 'Aux Ch#2 ON', 0),
                ('Additional_channel_1_on', 'Aux Ch#1 ON', 0),
                ('FSB', 'Power switch error', 0),
                ('charger', 'Charger connected', 0),
            ),
        },
        'extended_beacon': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('t_mb', 'Motherboard temperature, °C', 1),
                ('Mx', 'X magnetic field vector', 1),
                ('My', 'Y magnetic field vector', 1),
                ('Mz', 'Z magnetic field vector', 1),
                ('Vx', 'X velocity', 1),
                ('Vy', 'Y velocity', 1),
                ('Vz', 'Z velocity', 1),
                ('Nres', 'Reloads', 1),
                ('Rcon', 'Last Reload reason', 0),
                ('FL', 'Flags', 0),
                ('Time', 'Telemetry time', 0),
                ('FL_PL', 'PL Flags', 0),
                ('TimeSend', 'PL telemetry time', 0),
                ('T_Plate', 'PL Plate temperature', 1),
                ('T_CPU', 'PL microcontroller temperature', 1),
                ('CurSens1', 'Current sensor #1', 1),
                ('CurSens2', 'Current sensor #2', 1),
                ('NRst', 'Resets', 1),
                ('TimeRst', 'Last reset time', 0),
                ('CH1Rate', 'Ch#1 counting speed', 1),
                ('CH2Rate', 'Ch#2 counting speed', 1),
                ('CH3Rate', 'Ch#3 counting speed', 1),
                ('CH4Rate', 'Ch#4 counting speed', 1),
        ...
        'uhf_beacon': {
            'table': (
                ...
                ('Pf', 'Forward wave power, dBm', 1),
                ('Pb', 'Reflected wave power, dBm', 1),
                ('uhf_reset_counter', 'UHF reset counter', 1),
                ('FL', 'UHF flags', 0),
                ('Time', 'UHF time', 0),
                ('UpTime', 'Uptime', 0),
                ('RxBitrate', 'Uplink bitrate (Receive)', 1),
                ('CurrentConsumption', 'UHF consumption current, mA', 1),
                ('InputVoltage', 'UHF voltage, mV', 1),
            ),
            'flags': (
                ('NumActiveSchedules', 'Number of Active Schedules in executor', 0),
                ('ResetOccurredDuringExecution', 'Reboot occurred during schedule execution', 0),
                ('BackupScheduleActive', 'Backup schedule execution in progress', 0),
            ),
        },
        ...
        'get_Payload_FW_MSG': {
            'table': (
                ...
                ('Version', 'Version', 0),
                ('Release_Number', 'Release Number', 0),
            ),
        },
        ...
        'get_Payload_CURRENT_CONFIG': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('cur_seg2_write', 'Write addr in seg#1 (Monitor)', 0),
                ('cur_seg2_last_transmitted', 'Last transmitted addr in seg#1', 0),
                ('cur_seg2_min', 'First addr in seg#1', 0),
                ('cur_seg2_max', 'Last addr in seg#1', 0),
                ('cur_seg2_num', '"Through" number seg#1', 0),
                ('cur_seg3_write', 'Write addr in seg#2 (Event)', 0),
                ('cur_seg3_last_transmitted', 'Last transmitted addr in seg#2', 0),
                ('cur_seg3_min', 'First addr in seg#2', 0),
                ('cur_seg3_max', 'Last addr in seg#2', 0),
                ('cur_seg3_num', '"Through" number seg#2', 0),
                ('cur_seg4_write', 'Write addr in seg#3 (Array)', 0),
                ('cur_seg4_last_transmitted', 'Last transmitted addr in seg#3', 0),
                ('cur_seg4_min', 'First addr in seg#3', 0),
                ('cur_seg4_max', 'Last addr in seg#3', 0),
                ('cur_seg4_num', '"Through" number seg#3', 0),
                ('time_start_massive_write', 'Start time of deferred write to Array', 0),
                ('status_massive_write_enable', 'Array write enable flag', 0),
                ('time_monitor_x100ms', 'Monitor writing internal timer multiplier, ms', 0),
                ('can_device_id', 'CAN-payload ID', 0),
                ('can_station_id', 'CAN-station ID', 0),
                ('can_tranciever_id', 'CAN-tranciever ID', 0),
                ('TimeRst', 'Last reset time', 0),
                ('NRst', 'Resets', 0),
                ('max_zagruz', 'Configurable max PL load by activations number', 0),
                ('ch1_summ_threshold', 'Ch#1 trigger threshold (CH1Rate in Beacon)', 0),
                ('ch2_summ_threshold', 'Ch#2 trigger threshold (CH2Rate in Beacon)', 0),
                ('num_counter_channels', 'Channels for counting speed (TotalRate, CH1Rate, CH2Rate)', 0),
                ('time_save_configure', 'Save configure timeout, s', 0),
                ('data_correct', 'Config is correct', 0),
            ),
        },
        'regular_telemetry': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('VTG_S1', 'Solar Panel #1 voltage, mV', 1),
                ('VTG_S2', 'Solar Panel #2 voltage, mV', 2),
                ('VTG_S3', 'Solar Panel #3 voltage, mV', 2),
                ('CUR_S1', 'Solar Panel #1 current, mA', 1),
                ('CUR_S2', 'Solar Panel #2 current, mA', 2),
                ('CUR_S3', 'Solar Panel #3 current, mA', 2),
                ('CUR_BAT', 'Battery current, mA', 1),
                ('CUR_S1O', 'Channel #1 current, mA', 1),
                ('CUR_S2O', 'Channel #2 current, mA', 2),
                ('CUR_S3O', 'Channel #3 current, mA', 2),
                ('CUR_S4O', 'Channel #4 current, mA', 2),
                ('TMP_BAT1', 'Battery #1 temperature, °C', 1),
                ('TMP_BAT2', 'Battery #2 temperature, °C', 2),
                ('TMP_BAT3', 'Battery #3 temperature, °C', 2),
                ('TMP_BAT4', 'Battery #4 temperature, °C', 2),
                ('VBAT', 'Battery voltage, mV', 1),
                ('REC_ID', 'PSS Telemetry SN', 0),
                ('Time', 'PSS Time', 0),
                ('launch_number', 'PSS reset counter', 0),
                ('reset_reason', 'PSS Reset reason', 0),
            ),
            'flags': (
                ('VTG_BAT_CRIT', 'Critical battery voltage', 0),
                ('VTG_BAT_MIN', 'Minimal battery voltage', 0),
                ('HEATER2_Manual', 'Heater #2 manual', 0),
                ('HEATER1_Manual', 'Heater #1 manual', 0),
                ('HEATER2_ON', 'Heater #2 ON', 0),
                ('HEATER1_ON', 'Heater #1 ON', 0),
                ('TMP_MAX', 'Maximal battery Temperature', 0),
                ('TMP_MIN', 'Minimal battery Temperature', 0),
                ('CHANNEL4_ON', 'Ch#4 ON', 0),
                ('CHANNEL3_ON', 'Ch#3 ON', 0),
                ('CHANNEL2_ON', 'Ch#2 ON', 0),
                ('CHANNEL1_ON', 'Ch#1 ON', 0),
                ('ICH_FAULT_4', 'Ch#4 Fault', 0),
                ('ICH_FAULT_3', 'Ch#3 Fault', 0),
                ('ICH_FAULT_2', 'Ch#2 Fault', 0),
                ('ICH_FAULT_1', 'Ch#1 Fault', 0),
                ('Additional_channel_3_on', 'Aux Ch#3 ON', 0),
                ('Additional_channel_2_on', 'Aux Ch#2 ON', 0),
                ('Additional_channel_1_on', 'Aux Ch#1 ON', 0),
                ('FSB', 'Power switch error', 0),
                ('CHAGER', 'Charger connected', 0),
            ),
        },
        'extended_telemetry': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('CHRG_LIM', 'Charger current limit, mA', 1),
                ('TMP_MIN', 'Battery min temperature, °C', 1),
                ('TMP_MAX', 'Battery max temperature, °C', 1),
                ('VTG_BAT', 'Battery drawdown voltage, mV', 1),
                ('TIME_BAT', 'Battery drawdown time, ms', 1),
                ('CUR_LIM1', 'Ch#1 current limit', 1),
                ('CUR_LIM2', 'Ch#2 current limit', 1),
                ('CUR_LIM3', 'Ch#3 current limit', 1),
                ('CUR_LIM4', 'Ch#4 current limit', 1),
                ('DEV_ADDR', 'Device UniCAN address', 0),
                ('SRC_ADDR', 'Base station UniCAN address', 0),
                ('TEL_PER', 'Regular telemetry period, ms', 0),
                ('ETEL_PER', 'Extended telemetry period, s', 0),
                ('REC_ID', 'Packet SN', 0),
                ('ST_DELAY', 'Startup delay, s', 0),
                ('SW_VER', 'MCU firmware version', 0),
                ('DEPLOY_START_TIMER', 'Deploy start timer', 0),
                ('DEPLOY_STOP_TIMER', 'Deploy stop timer', 0),
                ('DEPLOY_MODE', 'Deploy mode', 0),
            ),
        },
        ...
        'switch_status': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('Ch0Status', 'Ch#0 status', 0),
                ('Ch1Status', 'Ch#1 status', 0),
                ('Ch2Status', 'Ch#2 status', 0),
                ('Ch3Status', 'Ch#3 status', 0),
            ),
        },
        'regular_telemetry6u': {
            'table': (
                ...
                ('Iab', 'Battery current, mA', 1),
                ('Uab', 'Battery voltage, mV', 1),
                ('Uab1', 'Voltage on cell #1, mV', 1),
                ('Uab2', 'Voltage on cell #2, mV', 1),
                ('t1_pw', 'Battery #1 temperature, °C', 1),
                ('t2_pw', 'Battery #2 temperature, °C', 1),
                ('capacity', 'Capacity', 1),
                ('reg_tel_id', 'PSS telemetry number', 0),
                ('Time', 'PSS telemetry time', 0),
                ('ps_reset_counter', 'PSS reset counter', 0),
                ('FL', 'PS flags', 0),
            ),
            'flags': (
                ('ch1_status', 'Ch#1 Status', 0),
                ('ch2_status', 'Ch#2 Status', 0),
                ('ch3_status', 'Ch#3 Status', 0),
                ('ch4_status', 'Ch#4 Status', 0),
                ('ch5_status', 'Ch#5 Status', 0),
                ('ch6_status', 'Ch#6 Status', 0),
                ('ch7_status', 'Ch#7 Status', 0),
                ('ch8_status', 'Ch#8 Status', 0),
                ('ch9_status', 'Ch#9 Status', 0),
                ('ch10_status', 'Ch#10 Status', 0),
                ('ch11_status', 'Ch#11 Status', 0),
                ('ch12_status', 'Ch#12 Status', 0),
                ('ch13_status', 'Ch#13 Status', 0),
                ('ch14_status', 'Ch#14 Status', 0),
                ('ch15_status', 'Ch#15 Status', 0),
                ('ch16_status', 'Ch#16 Status', 0),
                ('ch17_status', 'Ch#17 Status', 0),
                ('ch18_status', 'Ch#18 Status', 0),
                ('ch19_status', 'Ch#19 Status', 0),
                ('ch20_status', 'Ch#20 Status', 0),
                ('ch21_status', 'Ch#21 Status', 0),
                ('ch22_status', 'Ch#22 Status', 0),
                ('ch23_status', 'Ch#23 Status', 0),
                ('ch24_status', 'Ch#24 Status', 0),
                ('ch25_status', 'Ch#25 Status', 0),
                ('ch26_status', 'Ch#26 Status', 0),
                ('ch27_status', 'Ch#27 Status', 0),
                ('ch28_status', 'Ch#28 Status', 0),
                ('ch29_status', 'Ch#29 Status', 0),
                ('ch30_status', 'Ch#30 Status', 0),
                ('Tab_min', 'Minimal battery Temperature', 0),
                ('Tab_max', 'Maximal battery Temperature', 0),
                ('heater1_on', 'Heater #1 ON', 0),
                ('heater2_on', 'Heater #2 ON', 0),
                ...
                ('charger', 'Charger connected', 0),
                ('FSB', 'Power switch error', 0),
                ('AuxCH1_enabled_flag', 'Aux Ch#1 ON', 0),
                ('AuxCH2_enabled_flag', 'Aux Ch#2 ON', 0),
                ('AuxCH3_enabled_flag', 'Aux Ch#3 ON', 0),
            ),
        },
        'ps_regular_telemetry_5ch': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('VTG_SOL1', 'Solar Panel #1 Voltage, mV', 1),
                ('VTG_SOL2', 'Solar Panel #2 Voltage, mV', 1),
                ('VTG_SOL3', 'Solar Panel #3 Voltage, mV', 1),
                ('CUR_SOL1', 'Solar Panel #1 Current, mA', 1),
                ('CUR_SOL2', 'Solar Panel #2 Current, mA', 1),
                ('CUR_SOL3', 'Solar Panel #3 Current, mA', 1),
                ('CUR_BAT', 'Battery Current, mA', 1),
                ('CUR_PCH1', 'Ch#1 Current, mA', 1),
                ('CUR_PCH2', 'Ch#2 Current, mA', 1),
                ('CUR_PCH3', 'Ch#3 Current, mA', 1),
                ('CUR_PCH4', 'Ch#4 Current, mA', 1),
                ('CUR_PCH5', 'Ch#5 Current, mA', 1),
                ('TMP_BAT1', 'Battery #1 temperature, °C', 1),
                ('TMP_BAT2', 'Battery #2 temperature, °C', 1),
                ('TMP_BAT3', 'Battery #3 temperature, °C', 1),
                ('TMP_BAT4', 'Battery #4 temperature, °C', 1),
                ('VBAT', 'Battery voltage, mV', 1),
                ('REC_ID', 'PSS telemetry SN', 0),
                ('Time', 'PSS telemetry time', 0),
                ('ps_reset_counter', 'PSS reset counter', 0),
                ('reset_reason', 'PS reset reason', 0),
            ),
            'flags': (
                ('Tab_min', 'Minimal battery Temperature', 0),
                ('Tab_max', 'Maximal battery Temperature', 0),
                ...
                ('Ich_limit3', 'Exceeding channel #3 current', 0),
                ('Ich_limit4', 'Exceeding channel #4 current', 0),
                ('Ich_limit5', 'Exceeding channel #5 current', 0),
                ('channelon1', 'Ch#1 ON', 0),
                ('channelon2', 'Ch#2 ON', 0),
                ('channelon3', 'Ch#3 ON', 0),
                ('channelon4', 'Ch#4 ON', 0),
                ('channelon5', 'Ch#5 ON', 0),
                ('charger', 'Charger connected', 0),
                ('FSB', 'Power switch error', 0),
                ('AuxCH1_enabled_flag', 'Aux Ch#1 ON', 0),
                ('AuxCH2_enabled_flag', 'Aux Ch#2 ON', 0),
        ...
        'tm_adcs_beacon_old': {
            'table': (
                ...
                ('desc', 'Description', 0),
                ('Time', 'ECI time', 0),
                ('eci_quat_w', 'ECI quat w', 1),
                ('eci_quat_vect_x', 'ECI quat vect x', 1),
                ('eci_quat_vect_y', 'ECI quat vect y', 1),
                ('eci_quat_vect_z', 'ECI quat vect z', 1),
                ('eci_ave_x', 'ECI ave x', 1),
                ('eci_ave_y', 'ECI ave y', 1),
                ('eci_ave_z', 'ECI ave z', 1),
                ('orb_time', 'ORB time', 0),
                ('orb_quat_w', 'ORB quat w', 1),
                ('orb_quat_vect_x', 'ORB quat vect x', 1),
                ('orb_quat_vect_y', 'ORB quat vect y', 1),
                ('orb_quat_vect_z', 'ORB quat vect z', 1),
                ('orb_ave_x', 'ORB ave x', 1),
                ('orb_ave_y', 'ORB ave y', 1),
                ('orb_ave_z', 'ORB ave z', 1),
                ('forced_time', 'Forced time', 0),
                ('forced_quat_w', 'Forced quat w', 1),
                ('forced_quat_vect_x', 'Forced quat vect x', 1),
                ('forced_quat_vect_y', 'Forced quat vect y', 1),
                ('forced_quat_vect_z', 'Forced quat vect z', 1),
                ('forced_ave_x', 'Forced ave x', 1),
                ('forced_ave_y', 'Forced ave y', 1),
                ('forced_ave_z', 'Forced ave z', 1),
                ('ss_invalids', 'SS invalids', 1),
                ('wheel_invalids', 'Wheel invalids', 1),
            ),
            'flags': (
                ('eci_policy', 'ECI policy', 0),
                ('eci_invalid', 'ECI invalid', 0),
                ('orb_policy', 'ORB policy', 0),
                ('orb_invalid', 'ORB invalid', 0),
                ('forced_policy', 'Forced policy', 0),
                ('forced_invalid', 'Forced invalid', 0),
                ('mfs_invalid', 'MFS invalid', 0),
                ('avs_invalid', 'AVS invalid', 0),
            ),
        },
        'tm_adcs_beacon': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('Time', 'Current system time', 0),
                ('uptime', 'Uptime', 0),
                ('eci_quat_w', 'ECI quat w', 1),
                ('eci_quat_vect_x', 'ECI quat vect x', 1),
                ('eci_quat_vect_y', 'ECI quat vect y', 1),
                ('eci_quat_vect_z', 'ECI quat vect z', 1),
                ('eci_AV_x', 'ECI X Angular velocity, deg/s', 1),
                ('eci_AV_y', 'ECI Y Angular velocity, deg/s', 1),
                ('eci_AV_z', 'ECI Z Angular velocity, deg/s', 1),
                ('orb_quat_w', 'ORB quat w', 1),
                ('orb_quat_vect_x', 'ORB quat vect x', 1),
                ('orb_quat_vect_y', 'ORB quat vect y', 1),
                ('orb_quat_vect_z', 'ORB quat vect z', 1),
                ('orb_AV_x', 'ORB X Angular velocity, deg/s', 1),
                ('orb_AV_y', 'ORB Y Angular velocity, deg/s', 1),
                ('orb_AV_z', 'ORB Z Angular velocity, deg/s', 1),
                ('eci_forced_quat_w', 'ECI forced quat w', 1),
                ('eci_forced_quat_vect_x', 'ECI forced quat vect x', 1),
                ('eci_forced_quat_vect_y', 'ECI forced quat vect y', 1),
                ('eci_forced_quat_vect_z', 'ECI forced quat vect z', 1),
                ('eci_forced_AV_x', 'ECI forced X Angular velocity, deg/s', 1),
                ('eci_forced_AV_y', 'ECI forced Y Angular velocity, deg/s', 1),
                ('eci_forced_AV_z', 'ECI forced Z Angular velocity, deg/s', 1),
                ('latitude', 'Latitude, deg', 1),
                ('longitude', 'Longitude, deg', 1),
                ('altitude', 'Altitude, m', 1),
                ('adcs_task_type', 'Current task type', 0),
                ('adcs_task_quantity', 'Tasks quantity in scheduler', 0),
                ('wheel_rpm_x_plus', 'Wheels X+ angular velocity, rpm', 1),
                ('wheel_rpm_x_minus', 'Wheels X- angular velocity, rpm', 1),
                ('wheel_rpm_y_plus', 'Wheels Y+ angular velocity, rpm', 1),
                ('wheel_rpm_y_minus', 'Wheels Y- angular velocity, rpm', 1),
            ),
            'flags': (
                ('eci_policy', 'ECI policy', 0),
                ('eci_invalid', 'ECI invalid', 0),
                ('orb_policy', 'ORB policy', 0),
                ('orb_invalid', 'ORB invalid', 0),
                ('eci_forced_policy', 'ECI forced policy', 0),
                ('eci_forced_invalid', 'ECI forced invalid', 0),
                ('ballistics_policy', 'Ballistics policy', 0),
                ('gnss_invalid', 'GNSS invalid', 0),
                ('auto_ballistics_polity', 'Auto ballistics policy', 0),
                ('auto_control_policy', 'Auto control policy', 0),
                ('ss_active', 'Active sun sensor', 0),
                ('ss_invalid_x_plus', 'X+ Sun sensors invalid', 0),
                ('ss_invalid_x_minus', 'X- Sun sensors invalid', 0),
                ('ss_invalid_y_plus', 'Y+ Sun sensors invalid', 0),
                ('ss_invalid_y_minus', 'Y- Sun sensors invalid', 0),
                ('ss_invalid_z_plus', 'Z+ Sun sensors invalid', 0),
                ('ss_invalid_z_minus', 'Z- Sun sensors invalid', 0),
                ('ss_invalid_extra', 'Extra Sun sensors invalid', 0),
                ('star_tracker_invalid', 'Star tracker invalid', 0),
                ('avs_invalid', 'AVS invalid', 0),
                ('mfs_invalid', 'MFS invalid', 0),
                ('wheel_invalid_x_plus', 'Wheels X+ invalid', 0),
                ('wheel_invalid_x_minus', 'Wheels X- invalid', 0),
                ('wheel_invalid_y_plus', 'Wheels Y+ invalid', 0),
                ('wheel_invalid_y_minus', 'Wheels Y- invalid', 0),
                ('reset_reason', 'Last reset reason', 0),
            ),
        },
        'tm_adcs_beacon_6_wheels': {
            'table': (
                ...
                ('eci_forced_AV_y', 'ECI forced Y Angular velocity, deg/s', 1),
                ('eci_forced_AV_z', 'ECI forced Z Angular velocity, deg/s', 1),
                ('latitude', 'Latitude, deg', 0),
                ('longitude', 'Longitude, deg', 0),
                ('altitude', 'Altitude, m', 1),
                ('adcs_task_type', 'Current task type', 0),
                ('adcs_task_quantity', 'Tasks quantity in scheduler', 0),
                ('wheel_rpm_1', 'Wheels #1 angular velocity, rpm', 1),
                ('wheel_rpm_2', 'Wheels #2 angular velocity, rpm', 1),
                ('wheel_rpm_3', 'Wheels #3 angular velocity, rpm', 1),
                ('wheel_rpm_4', 'Wheels #4 angular velocity, rpm', 1),
                ('wheel_rpm_5', 'Wheels #5 angular velocity, rpm', 1),
                ('wheel_rpm_6', 'Wheels #6 angular velocity, rpm', 1),
                ('reset_reason', 'Last reset reason', 0),
            ),
            'flags': (
                ('eci_policy', 'ECI policy', 0),
                ...
                ('avs_invalid', 'AVS invalid', 0),
                ('mfs_invalid', 'MFS invalid', 0),
                ('wheel_invalid_1', 'Wheels #1 invalid', 0),
                ('wheel_invalid_2', 'Wheels #2 invalid', 0),
                ('wheel_invalid_3', 'Wheels #3 invalid', 0),
                ('wheel_invalid_4', 'Wheels #4 invalid', 0),
                ('wheel_invalid_5', 'Wheels #5 invalid', 0),
                ('wheel_invalid_6', 'Wheels #6 invalid', 0),
            ),
        },
        'ch_adc_X1': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('ADC_X1', 'Ch#X1 value', 1),
                ('Temp_Ext', 'Sensor temperature at detector, °C', 1),
            ),
        },
        'ch_adc_X2': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('ADC_X2', 'Ch#X2 value', 1),
                ('Temp_Int', 'MCU sensor temperature, °C', 1),
            ),
        },
        'ch_adc_Y1': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('ADC_Y1', 'Ch#Y1 value', 1),
                ('ADC_Ext', 'External temperature sensor readings', 1),
            ),
        },
        'ch_adc_Y2': {
            'table': (
                ('name', 'Name', 0),
                ('desc', 'Description', 0),
                ('ADC_Y2', 'Ch#Y2 value', 1),
                ('ADC_Int', 'Internal temperature sensor readings', 1),
            ),
        },
        'temp_cur_X1': {
            'table': (
