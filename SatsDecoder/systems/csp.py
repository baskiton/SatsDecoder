...
class CspProtocol(common.Protocol):
    ...
    tlm_table = {
        'frame': {
            'table': (
                ('priority', 'Priority', 0),
                ('src', 'Source address', 0),
                ('src_port', 'Source port', 0),
                ('dest', 'Destination address', 0),
                ('dest_port', 'Destination port', 0),
                ('frag', 'Use fragmentation', 0),
                ('hmac', 'Use HMAC verification', 0),
                ('xtea', 'Use XTEA encryption', 0),
                ('use_rdp', 'Use RDP protocol', 0),
                ('use_crc', 'Use CRC32 checksum', 0),
                ('data', 'Data', 0),
                ('hex', 'Data (HEX)', 0),
                # ('crc32', 'CRC32 (HEX)', 0),
            ),
