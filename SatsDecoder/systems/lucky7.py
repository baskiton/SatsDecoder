    ...
    tlm_table = {
        'lucky7_tlm': {
            'table': (
                ...
                ('mcu_t', 'MCU Temperature, °C', 1),
                ('pa_t', 'PA Temperature, °C', 2),
                ('cpu_i', 'Processor Current, mA', 1),
                ('mcu_3v3_u', 'MCU Voltage 3V3, mV', 1),
                ('mcu_1v2_u', 'MCU Voltage 1V2, mV', 2),
                ('ang_x', 'Angular rate X axis, deg/s', 1),
                ('ang_y', 'Angular rate Y axis, deg/s', 2),
                ('ang_z', 'Angular rate Z axis, deg/s', 2),
