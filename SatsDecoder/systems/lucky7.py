    ...
    tlm_table = {
        'lucky7_tlm': {
            'table': (
                ('name', 'Name', 0),
                ('obc_id', 'OBC ID', 0),
                ('mission_cnt', 'Mission counter', 0),
                ('callsign', 'Callsign', 0),
                ('sat_name', 'Satellite Name', 0),
                ('tot_resets', 'Total Reset Counter', 0),
                ('swap_resets', 'Swap Reset Counter', 0),
                ('bat_u', 'Battery voltage, mV', 0),
                ('mcu_t', 'MCU Temperature, °C', 0),
                ('pa_t', 'PA Temperature, °C', 0),
                ('cpu_i', 'Processor Current, mA', 0),
                ('mcu_3v3_u', 'MCU Voltage 3V3, mV', 0),
                ('mcu_1v2_u', 'MCU Voltage 1V2, mV', 0),
                ('ang_x', 'Angular rate X axis, deg/s', 0),
                ('ang_y', 'Angular rate Y axis, deg/s', 0),
                ('ang_z', 'Angular rate Z axis, deg/s', 0),
                ('ant_burnware', 'Antenna Burnwire', 0),
            ),
        },
    }
