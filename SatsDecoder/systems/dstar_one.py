...
class DStarOneProtocol(common.Protocol):
    ...
    tlm_table = {
        'dstar_one': {
            'table': (
                ('name', 'Name', 0),
                ('p_len', 'Packet length', 0),
                ('p_id', 'Packet ID', 0),
                ('Time', 'System clock time, s', 0),
                ('reboots', 'Reboots counter', 0),
                ('rtc_val', 'RTC value', 0),
                ('adc0_0', 'Bat charge in, mA', 0),
                ('adc0_1', 'Bat charge out, mA', 0),
                ('adc0_2', 'Bat voltage, V', 0),
                ('adc0_3', '5V supply, V', 0),
                ('adc0_4', '3V3 supply, V', 0),
                ('adc0_5', 'PCU total curr, mA', 0),
                ('adc0_6', 'Solar +X curr, mA', 0),
                ('adc0_7', 'Solar -X curr, mA', 0),
                ('adc0_8', 'Solar +Y curr, mA', 0),
                ('adc0_9', 'Solar -Y curr, mA', 0),
                ('adc0_10', 'Solar +Z curr, mA', 0),
                ('adc0_11', 'Solar -Z curr, mA', 0),
                ('adc0_12', 'Solar total voltage, V', 0),
                ('adc0_13', 'VCC out0 curr, mA', 0),
                ('adc0_14', 'VCC out1 curr, mA', 0),
                ('adc0_15', 'VCC out2 curr, mA', 0),
                ('adc1_0', 'VCC out3 curr, mA', 0),
                ('adc1_1', 'VCC out4 curr, mA', 0),
                ('adc1_2', 'VCC out5 curr, mA', 0),
                ('adc1_3', 'VCC out6 curr, mA', 0),
                ('adc1_4', 'VCC out7 curr, mA', 0),
                ('adc1_5', 'SS total curr, mA', 0),
                ('adc1_6', 'EEPROM1 curr, mA', 0),
                ('adc1_7', 'EEPROM2 curr, mA', 0),
                ('adc1_8', 'Ext ADC1 curr, mA', 0),
                ('adc1_9', 'Ext ADC2 curr, mA', 0),
                ('adc1_10', 'Ext ADC3 curr, mA', 0),
                ('adc1_11', 'Ext ADC4 curr, mA', 0),
                ('adc1_12', 'RTC curr, mA', 0),
                ('adc1_13', 'Charger DCDC voltage, V', 0),
                ('adc1_14', 'System V, V', 0),
                ('adc1_15', 'OBC curr, mA', 0),
                ('switches', 'Mask of system power switches', 0),
                ('rsrv0', 'Reserved', 0),
                ('batt_temp', 'Temperature sensor of battery pack', 0),
                ('schedule', 'Count of scheduled commands', 0),
                ('rsrv1', 'Reserved', 0),
                ('mode', 'Current satellite mode', 0),
                ('filler', 'Filler', 0),
                ('crc', 'CRC16', 0),
            ),
        },
